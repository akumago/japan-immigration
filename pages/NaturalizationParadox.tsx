                        ...
                        <div className="prose prose-invert prose-lg max-w-none relative z-10">
                            ...
                            <div className="grid md:grid-cols-2 gap-12">
                                ...
                                <div>
                                    ...
                                    <p className="leading-relaxed text-gray-300">
                                        欧米諸国における市民権（国籍）取得プロセスと比較すると、日本の制度の異常性は際立つ。アメリカにおける厳格な歴史・政治体制の試験と「武器を取って国を守る」という宣誓、イギリスにおけるLife in the UKテストなど、他国は「新たな市民が国家の価値観を共有できるか」を徹底的にスクリーニングする。対して日本には、国家に対する忠誠を誓わせる法的枠組みすら存在しない。歴史観も国家観も異なる人口に対し、自国のアイデンティティへの同化を求めずして国籍を無防備に与えることは、国際標準から著しく逸脱した「国家としての自殺行為」に近い。
                                    </p>
                                </div>
