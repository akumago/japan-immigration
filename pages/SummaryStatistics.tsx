...
export const SummaryStatistics: React.FC = () => {
    return (
        <MainLayout>
            <Helmet>
                <title>総括：統計的客観事実が示す政策見直しの必要性 | 日本の岐路</title>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 border border-white/10 rounded-2xl p-10 shadow-2xl mb-12">
                    <h3 className="text-3xl font-bold text-white mb-8 border-b border-white/10 pb-4">
                        警察庁公式データの重み
                    </h3>
                    <div className="text-center py-10 bg-black/40 rounded-xl mb-8">
                        <p className="text-gray-400 mb-4 text-xl">居住者同士の検挙人口比</p>
                        <p className="text-6xl font-bold text-red-500">1.72<span className="text-2xl ml-2">倍</span></p>
                    </div>
                    <p className="text-gray-300 text-lg leading-relaxed">
                        参議院内閣委員会において示されたこの数字は、もはや「文化の違い」や「一部の事例」では片付けられない構造的な課題を浮き彫りにしています。
                        この格差を直視せずに受け入れを拡大することは、国家の安全保障と治安に対する無責任な判断と言わざるを得ません。
                    </p>
                </div>
                <div className="space-y-10 mb-12 text-gray-300">
                    <div className="border-l-4 border-blue-500 pl-6">
                        <h3 className="text-xl font-bold text-white mb-4">「1.72倍」という数字の意味するもの</h3>
                    ...
                    <div className="border-l-4 border-yellow-500 pl-6">
                        <h3 className="text-xl font-bold text-white mb-4">なぜこの数字が長い間、表に出なかったのか</h3>
                        <p className="leading-relaxed mb-4">
                    ...
                    <div className="border-l-4 border-red-500 pl-6">
                        <h3 className="text-xl font-bold text-white mb-4">海外比較：他国の移民犯罪統計と政策対応</h3>
                        <p className="leading-relaxed mb-4">
                    ...
                    <div className="bg-gray-800/50 border border-red-500/20 rounded-xl p-8">
                        <h3 className="text-xl font-bold text-white mb-4">まとめ・考察：データを直視することが出発点</h3>
                        <p className="leading-relaxed mb-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-6">
                        <h3 className="text-xl font-bold text-white mb-4">1.72倍格差を超えた問題の深層</h3>
                        <p className="leading-relaxed mb-4">
                    ...
                    <div className="border-l-4 border-orange-400 pl-6">
                        <h3 className="text-xl font-bold text-white mb-4">海外比較：データを直視した国の行方</h3>
                        <p className="leading-relaxed mb-4">
                    ...
                    <div className="bg-gray-800/50 border border-green-500/20 rounded-xl p-8">
                        <h3 className="text-xl font-bold text-white mb-4">まとめ：数字が告発する政策不作為</h3>
                        <p className="leading-relaxed mb-4">
                ...
                <RelatedArticles currentPath="/analysis/summary-statistics" />
            </main>
        </MainLayout>
    );
};
