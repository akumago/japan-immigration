                ...
                <div className="mt-16 mb-12 space-y-12 bg-black/60 p-8 md:p-10 rounded-2xl border border-red-900/50 shadow-2xl relative overflow-hidden backdrop-blur-sm">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none relative z-10">
                        ...
                        <h3 className="text-2xl font-semibold text-red-400 mt-10 mb-4 flex items-center">
                            ...
                            1. 【統計の裏側】「人手不足」プロパガンダに隠された国内余剰労働力の不可視化
                        </h3>
                        <p className="mb-6 leading-relaxed text-gray-300">
                            「日本は決定的に人手が不足している」という大義名分は、緻密に構成された経済的プロパガンダである。労働力調査の統計を仔細に分析すれば、国内には未だ非正規雇用で燻る若年層、就労調整を余儀なくされている女性、そして豊富な経験を持ちながら労働市場から排除されている高齢層といった「潜在的・余剰労働力」が数百万規模で存在している。真の問題は「人がいない」ことではなく、「現在の低賃金・悪条件で働く人がいない」という待遇のアノマリー（異常性）にある。ここに途上国からの安価な労働力を投入することは、市場における「賃金による需給調整機能」を人為的に破壊し、国内の潜在的労働者を永久に「見えない失業状態」へと固定化させる冷酷な政策的選択を意味している。
                        </p>
