...
const MUNICIPALITY_MAP = {
  ...
  '浅草橋': '東京都', '羽田': '東京都', '大田区': '東京都', '新宿': '東京都', '渋谷': '東京都', '池袋': '東京都', '足立': '東京都', '江戸川': '東京都', '八王子': '東京都', '町田': '東京都', '世田谷': '東京都', '歌舞伎町': '東京都', '六本木': '東京都', '大久保': '東京都', '牛込': '東京都',
...
const EXCLUDE_KEYWORDS = [
  ...
  '中国ネット', '強制送還され',
  '外国人装い', '外国人を装', '外国人のふり', '外国人になりすま', '外国人に扮',
  '!!', '!?', 'ドラマ', '最終回', '第1話', '第2話', '第3話', '第4話', '第5話',
