...
const EXCLUDE_KEYWORDS = [
  ...
  // 被害者側の刑事告訴・被害申告事案、および論考・チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ記事の除外
...
function isSameEvent(itemA, itemB) {
  ...
  // 特例：福岡・ネパール国籍女性殺人事件（男女3人逮捕・佐賀等のサテライト局報道統合）
  if ((titleA.includes('ネパール') && titleB.includes('ネパール')) &&
      (titleA.includes('3人') && titleB.includes('3人')) &&
      (titleA.includes('殺害') || titleA.includes('殺人')) &&
      (titleB.includes('殺害') || titleB.includes('殺人'))) {
    return true;
  }
...
function extractItemsFromRSS(xml) {
  ...
  for (const itemXml of itemMatches) {
    ...
    if (titleMatch && linkMatch) {
      ...
      const isAwarenessOrColumn = /チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|録画[０-９0-9]|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ|チラシで周知|協力を.*呼びかけ|注意を呼びかけ|防犯教室|啓発|連載|金難民|録画[０-９0-9]|覚えているだろうか|デイリー新潮|薬師寺の国宝|立ち入り調査|摘発強化へ|他省庁と合同|実施へ/.test(title);
